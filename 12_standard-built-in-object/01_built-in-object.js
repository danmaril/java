...
console.log(userId.toLowerCase().trim());
...
const randomNumber = Math.floor(Math.random() * 10) + 1;   // Math.floor(Math.random() * 6) + 1; (주사위)
