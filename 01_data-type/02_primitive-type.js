...
// null: 명시적으로 값이 없을을 의도적으로 명시할 때 사용한다.
var address = null;
console.log(address);
...
// typeof: 데이터 타입을 확인할 떄 사용
console.log(typeof age);
console.log(typeof string);
console.log(typeof isStudent);
console.log(typeof salary);
// 자바스크립트의 첫 번째 버전의 버그 null -> object 로 표시
console.log(typeof address);

/*
    템플릿 리터럴
    ES6부터 도입 된 멀티라인 물자열, 표현식 삽입 등의 편리한 문자열 처리 기능을 제공하는 문자열 표기법
